...
#calculate formula for largest, smallest, average  rainfall
...
def averageRainFall(arr, n):
    sum=0
    for i in range(n):
        sum += arr[i] #compound assignment operators
    return sum/n
...
def main():
    ...
    Ans = smallestRainFall(listRainFall, 12)
